...
const TestimonialCard = ({ image, quote, name, company }) => {
  return (
    <div className="flex flex-col items-center p-8 text-center bg-[#110b2b] rounded-2xl h-full ">
      <img
        src={image}
        alt={name}
        className="w-25 h-25 rounded-full object-cover mb-4 "
      />
      <p className="text-gray-300 mb-6 text-base italic">"{quote}"</p>
...
const EmblaCarousel = ({ options = { loop: true, align: "start" } }) => {
  ...
  return (
    <section className="max-w-8xl mx-auto p-4 bg-[#110b2b]">
